...
class Interval4Screen:
    def __init__(self):
        ...
        # Defining fonts
        self.small_font = pygame.font.Font("assets/font/IMFellEnglish-Regular.ttf", 24)
        self.x_small_font = pygame.font.Font("assets/font/IMFellEnglish-Regular.ttf", 16)

        # Sounds
        self.background_sound = pygame.mixer.Sound('assets/sounds-effects/Alone at Twilight 5.wav')
        self.click_sound = pygame.mixer.Sound('assets/sounds-effects/click-keyboard.mp3')
