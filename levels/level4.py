...
def load_assets():
    assets = {
        "background": pygame.image.load('assets/background/background-sky.png').convert(),
        "gameover": pygame.image.load('assets/background/GAMEOVER4.png').convert(),
        "plank": pygame.transform.scale(pygame.image.load('assets/solo_assets/plank.png').convert_alpha(), (75, 123)),
        "floor": pygame.transform.scale(pygame.image.load('assets/solo_assets/floor.png').convert_alpha(), (320, 250)),
        "moon": pygame.transform.scale(pygame.image.load('assets/objects/moon.png').convert_alpha(), (102, 100)),
        "sounds": {
            "background": pygame.mixer.Sound('assets/sounds-effects/witch-forest-atmo-24654.mp3'),
            "bridge": pygame.mixer.Sound('assets/sounds-effects/wood-creaking.mp3'),
            "click": pygame.mixer.Sound('assets/sounds-effects/click-keyboard.mp3'),
        },
    }
